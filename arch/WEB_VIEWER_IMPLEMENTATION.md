...
> **Status: historical design note.** This planning work became
> [ver-por-que](https://teotl.dev/ver-por-que), which now lives in its own
> repository. Kept as a record; not published. The JSON export it consumes is
> documented in `docs/guides/serialization.md`.
